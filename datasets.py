...
class pcd(Dataset):
    ...
    def __init__(self,root):
        ...
        #self.img_t0_root = './TSUNAMI/train/t0'         #pjoin(root,'t0')
        #self.img_t1_root = './TSUNAMI/train/t1'         #pjoin(root,'t1')
        #self.img_mask_root = './TSUNAMI/train/mask'     #pjoin(root,'mask')

        #root = './TSUNAMI/train/'

        self.img_t0_root = root + '/t0'         #pjoin(root,'t0')
        self.img_t1_root = root + '/t1'         #pjoin(root,'t1')
        self.img_mask_root = root + '/mask'     #pjoin(root,'mask')




        #print(self.img_t0_root)
        #print(self.img_t1_root)
        #print(self.img_mask_root)
        #print(root)
